...
#define FLUX_TOOLTIP_OFFSET          4.0f

/** @brief Opaque tooltip manager. */
...
/**
 * @brief Force-dismiss the current tooltip.
 */
void flux_tooltip_dismiss(FluxTooltip *tt);

/**
 * @brief Returns true if the tooltip popup is currently visible.
 */
