...
void flux_register_builtins(FluxControlRegistry *reg) {
	...
	flux_control_registry_register(reg, FLUX_CONTROL_SELECTOR_BAR, flux_draw_container, NULL);
	flux_control_registry_register(reg, FLUX_CONTROL_SELECTOR_BAR_ITEM, flux_draw_selector_bar_item, NULL);
	flux_control_registry_register(reg, FLUX_CONTROL_BREADCRUMB_ITEM, flux_draw_breadcrumb_item, NULL);
