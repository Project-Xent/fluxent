...
class DirectManipulationEventHandler
    : public RuntimeClass<RuntimeClassFlags<ClassicCom>, IDirectManipulationViewportEventHandler>
{
public:
  DirectManipulationEventHandler(Window *window) : window_(window) {}

  IFACEMETHODIMP OnViewportStatusChanged(IDirectManipulationViewport *viewport,
  ...
  IFACEMETHODIMP OnViewportUpdated(IDirectManipulationViewport *viewport) override { return S_OK; }

  IFACEMETHODIMP OnContentUpdated(IDirectManipulationViewport *viewport,
  ...
  IFACEMETHODIMP OnInteraction(IDirectManipulationViewport2 *viewport,
